...
![TF-IDF](https://img.shields.io/badge/TF--IDF-NLP-blueviolet?style=for-the-badge&logo=databricks&logoColor=white)
...
|:---|:---|:---|
| 🤖 **AI Text Summarizer** | Python-based NLP summarization engine | Python, NLTK, Regex |
| 📄 **Resume Screening NLP** | TF-IDF + cosine similarity resume matcher | Python, Scikit-Learn, Pandas |
...
*Always open to collaborating, contributing to open source, or just a good tech conversation.*
...
<picture>
  ...
  <img alt="github-snake" src="https://raw.githubusercontent.com/its-dhruvika/its-dhruvika/output/github-contribution-grid-snake.svg"/>
</picture>
